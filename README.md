...
- [Jitsi Meet](https://meet.jit.si/) - Up to 50 users in one room. Open Source Video Conferencing, which is behind 8x8 Video Meetings, Rocket.chat, Matrix/Riot and more. No registration needed. Has apps for iOS & Android and can be used in the browser at the PC. It can be self-hosted. 
...
- [Google Hangouts](https://hangouts.google.com/) - Up to 25 users, screen sharing, apps for Android, iOS and works in the browser
- [Facetime](https://support.apple.com/en-gb/HT204380) - Apple only video calls on Mac and iPhone, maximum of 32 users
...
- [Codenames](https://codenames.game/) - a clue giving game for two teams. 4+ players
- [Codenames](https://www.horsepaste.com/) - alternate (worse) website for Codenames.
...
- [UNO](https://store.steampowered.com/app/470220/UNO/) - 1-4 players, a classic card game of color and number matching
...
- [Skribbl.io](https://skribbl.io/) - take it in turns to guess each other's drawings
- [LetsDraw](https://letsdraw.it/) - Pictionary, drawing contest and competitive copying
...
Hop on a voice or video call and all start watching a film on your favourite streaming service, or live TV, at the same time. It's _almost_ like being in the same room. Though you'll have to all hit play at the same time!
